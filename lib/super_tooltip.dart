...
class _ExtendedTooltipState extends State<SuperTooltip>
  ...
  void _createOverlayEntries() {
    ...
    final Offset target = renderBox.localToGlobal(size.center(Offset.zero));
...
class _TooltipPositionDelegate extends SingleChildLayoutDelegate {
  ...
  BoxConstraints getConstraintsForChild(BoxConstraints constraints) {
    ...
    // TODO: This scenerio should likely be avoided in the initial functions
  ...
  Offset getPositionForChild(Size size, Size childSize) {
    // TODO: If there isn't enough space for the child on the preferredDirection
      ...
      case PreferredDirection.down:
        return _getBottomRightPath(rect)
          ..lineTo(
              ...
              rect.top)
          ..lineTo(
              target.dx, target.dy + arrowTipDistance) // up to arrow tip   \
          ..lineTo(
              max(
